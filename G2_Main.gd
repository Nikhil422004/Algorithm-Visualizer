...
func _initialize_data():
	edges = {
		"1_2": $Graph2/Edges/E1/Edge1,
		"1_3": $Graph2/Edges/E2/Edge2,
		"2_3": $Graph2/Edges/E3/Edge3,
		"2_4": $Graph2/Edges/E5/Edge5,
		"2_5": $Graph2/Edges/E7/Edge7,
		"3_2": $Graph2/Edges/E4/Edge4,
		"3_4": $Graph2/Edges/E8/Edge8,
		"3_5": $Graph2/Edges/E6/Edge6,
		"5_4": $Graph2/Edges/E9/Edge9,
	}

	labels = {
		"1_2": $Graph2/Edges/E1/ELabel1,
		"1_3": $Graph2/Edges/E2/ELabel2,
		"2_3": $Graph2/Edges/E3/ELabel3,
		"2_4": $Graph2/Edges/E5/ELabel5,
		"2_5": $Graph2/Edges/E7/ELabel7,
		"3_2": $Graph2/Edges/E4/ELabel4,
		"3_4": $Graph2/Edges/E8/ELabel8,
		"3_5": $Graph2/Edges/E6/ELabel6,
		"5_4": $Graph2/Edges/E9/ELabel9,
	}

	TDlabel = {
		"TD1": $Graph2/Nodes/A/TDlabelA,
		"TD2": $Graph2/Nodes/B/TDlabelB,
		"TD3": $Graph2/Nodes/C/TDlabelC,
		"TD4": $Graph2/Nodes/D/TDlabelD,
		"TD5": $Graph2/Nodes/E/TDlabelE,
	}
	
	fedges = {
		"1_2": $"Graph2 Viz/Edges/E1",
		"1_3": $"Graph2 Viz/Edges/E2",
		"2_3": $"Graph2 Viz/Edges/E3",
		"2_4": $"Graph2 Viz/Edges/E5",
		"2_5": $"Graph2 Viz/Edges/E7",
		"3_2": $"Graph2 Viz/Edges/E4",
		"3_4": $"Graph2 Viz/Edges/E8",
		"3_5": $"Graph2 Viz/Edges/E6",
		"5_4": $"Graph2 Viz/Edges/E9",
	}

	fbuttons = {
		"B1": $"Graph2 Viz/Button/BA",
		"B2": $"Graph2 Viz/Button/BB",
		"B3": $"Graph2 Viz/Button/BC",
		"B4": $"Graph2 Viz/Button/BD",
		"B5": $"Graph2 Viz/Button/BE",
